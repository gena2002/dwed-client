...
export class AdminProductTypeStore {
    constructor() {
        makeAutoObservable(this);
    }
    /* Получение списка типа товаров */
    ...
    public async get_all(
        ...
        try {
            ...
            const response = await AdminProductType.get_all(limit, offset, search);
    ...
    public async post(
        ...
        try {
            ...
            return await AdminProductType.post(name);
        } catch (e: any) {
            return e?.response;
        } finally {
    ...
    public async get(
        ...
        try {
            ...
            const response = await AdminProductType.get(id);
    ...
    public async patch(
        ...
        try {
            ...
            return await AdminProductType.patch(id, name);
        } catch (e: any) {
            return e?.response;
        } finally {
    ...
    public async delete(
        ...
        try {
            ...
            return await AdminProductType.delete(id);
        } catch (e: any) {
            return e?.response;
        } finally {
